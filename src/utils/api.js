...
const backendURL = isProd
  ? (import.meta.env.VITE_BACKEND_URL_PROD || "https://skillbridge-ai-web-backend.onrender.com")
  : (import.meta.env.VITE_BACKEND_URL_DEV || "http://localhost:5000");
...
const api = axios.create({
  ...
  timeout: 180000, // 180 seconds timeout for Render AI cold starts
});
