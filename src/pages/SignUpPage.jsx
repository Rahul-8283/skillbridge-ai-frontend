          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                disabled={isLoading}
                className="w-full bg-slate-800 text-white placeholder-gray-500 px-3 py-2 rounded-lg border border-slate-700 focus:border-blue-400 focus:outline-none transition-colors disabled:opacity-50 text-sm"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                disabled={isLoading}
                className="w-full bg-slate-800 text-white px-3 py-2 rounded-lg border border-slate-700 focus:border-blue-400 focus:outline-none transition-colors cursor-pointer disabled:opacity-50 text-sm"
              >
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-600/50 text-white font-semibold py-2 rounded-lg transition-all duration-300 disabled:cursor-not-allowed text-sm"
            >
            ...
            <button
              ...
              className="w-full bg-white hover:bg-gray-100 text-slate-900 font-semibold py-2 flex items-center justify-center rounded-lg transition-all text-sm"
            >
